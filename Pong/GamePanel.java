...
public class GamePanel extends JPanel implements ActionListener, KeyListener
{
	...
	public void paintComponent (Graphics g)
	{
		...
		p1.paintComponent(g);
		// Paddle 2
		Paddle p2 = new Paddle(locx2,locy2);
		p2.paintComponent(g);
		// Ball
		...
		if (scoreB == 9)
			g.drawString("Player 2 Wins!",220,100);
		// Pause
	...
	public void keyPressed (KeyEvent e)
	{
		...
		// Moves the paddles up and down when the keys are pressed.
	...
	{
		int code = e.getKeyCode();
		// Stops the paddles from moving when the keys are released.
		if (code == KeyEvent.VK_W)
			changeY1 = 0;
		if (code == KeyEvent.VK_S)
			changeY1 = 0;
